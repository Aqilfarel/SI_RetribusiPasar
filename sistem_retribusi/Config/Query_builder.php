...
class Query_builder implements Query
{
    ...
    public function get()
    {
        ...
        $this->v_query .= " FROM " . $this->v_table . " "; // select npm,nmaa from data_pedagang
        ...
        if (!empty($this->v_where)) {
            $this->v_query .= $this->v_order_by . " "; // select * from data_pedagang where order_by no_registrasi asc/ desc
        }
